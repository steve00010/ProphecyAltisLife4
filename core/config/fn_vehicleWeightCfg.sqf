...
switch (_className) do
{
	...
	case "I_Truck_02_covered_F": {300}; // Zamak Covered
	case "I_Truck_02_transport_F": {300}; // Zamak
	case "I_Truck_02_Box_F": {400}; // Zamak Box
	...
	case "B_Boat_Armed_01_minigun_F": {75};
	case "I_Boat_Armed_01_minigun_F": {75};

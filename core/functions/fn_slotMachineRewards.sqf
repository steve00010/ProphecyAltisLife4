...
{
   if(_slotType == 0)then {_ret = 450;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 900;};   //average joe's
   if(_slotType == 2)then {_ret = 1800;};  //high roller's
};
...
if((_idxA == 3 && _idxB == 3 && _idxC != 3) or (_idxA == 3 && _idxB != 3 && _idxC == 3) or (_idxA != 3 && _idxB == 3 && _idxC == 3))then // 2 Bells + Any     
{
   ...
   if(_slotType == 1)then {_ret = 800;};   //average joe's
   if(_slotType == 2)then {_ret = 1600;};  //high roller's
};

if((_idxA == 2 && _idxB == 2 && _idxC != 2) or (_idxA == 2 && _idxB != 2 && _idxC == 2) or (_idxA != 2 && _idxB == 2 && _idxC == 2))then // 2 Grapes + Any     
{
   if(_slotType == 0)then {_ret = 350;};   //penny snatcher's
...
{
   if(_slotType == 0)then {_ret = 300;};   //penny snatcher's
...
{
   if(_slotType == 0)then {_ret = 250;};   //penny snatcher's

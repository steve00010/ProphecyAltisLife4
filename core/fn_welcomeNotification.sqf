...
_message = _message + "We are a serious Roleplay server and require you to read and accept the rules found at<a href=http://prophecygaming.co.uk/rules.php color='#0033CC'> www.propechygaming.co.uk/rules</a> otherwise you will not be able to join or will end up banned!<br /><br />";
...
_message = _message + "Contact an Admin or Community Support member for assistance at any time should you need it!<br /><br /><br />";
_message = _message + "Most of all, Have Fun!";
...
<t size='0.8px'>- We have a top 10 bounty list on our web-page.</t><br/>
<t size='0.8px'>- Gangs are permanent, that's why they cost so much, if you acquire 100 mil we can build you a base, full details on the forum.</t><br/>

...
class playerSettings {
	...
	class controls {
		...
		class itemCHeader : Life_RscText
		{
			idc = -1;
			colorBackground[] = {0,0.2,0.8,0.8};
			text = "Item Controls";
		...
		*/
		...
		class ButtonKeys : Life_RscButtonMenu {
			...
			x = 0.102 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.8 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		};
		class ButtonMarket : Life_RscButtonMenu {
			...
			x = 0.103 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.8 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		};
		class ButtonCell : Life_RscButtonMenu {
			...
			x = 0.265 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.8 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		};
		class ButtonSyncData : life_RscButtonMenu {
			...
			x = 0.425 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.8 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		};
